# -*- coding: utf-8 -*-
# -------------------------------------------------------------------
# Filename: base_radial_acceptance_map_creator.py
# Purpose: Base class for common functionalities to creation of background model with spatial circular symmetry rotation
